<template>
  <el-card title="省市区选择器">
    <div class="pb-4">
      <div>默认用法：</div>
      <choose-area></choose-area>
    </div>
    <div class="pb-4">
      <div>数据来源：https://raw.githubusercontent.com/modood/Administrative-divisions-of-China/master/dist/pca.json</div>
    ...
    <div>
      ...
      <choose-area
        clearable
        plain
        :value="{ province: { code: '12', name: '天津市' }, city: { code: '1201', name: '市辖区' }, area: { code: '120102', name: '河东区' } }"
      ></choose-area>
    </div>
  </el-card>
</template>
