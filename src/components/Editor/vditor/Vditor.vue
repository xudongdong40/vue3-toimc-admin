...
<script lang="ts">
  ...
  import type { ToolbarItem, LangType, ModeType, ThemeType, IconType } from './types'
      ...
      const initEditor = (type?: string) => {
        if (vditor.value) {
          ...
          vditorIns.value = new Vditor(vditor.value, {
            mode: props.mode,
            value: props.value || demoContent.value,
            lang: props.lang,
